...
QUERIES = [
    '"water restriction" OR "water ban" OR "water rationing" OR "water shortage" United States',
    '"aquifer depletion" OR "groundwater decline" OR "well going dry" United States',
    '"reservoir low" OR "reservoir level" OR "water supply" shortage United States 2025 OR 2026',
]
...
EXCLUSION_PATTERNS = [
    ...
    r"\bwater polo\b",
    r"\bwater pistol\b",
    r"\bflood\b",            # floods handled by floodwire2
]

SYSTEM_PROMPT = """You are a relevance screener for a water scarcity news wire.
